...
echo 'check ELAPSED with a done.txt entry that is newer that the recurrence and won''t be added' >> todo_verify.txt
echo 'check ELAPSED with a done.txt entry that is older that the recurrence and will be added'   >> todo_verify.txt
#
# two entries to be sure it grabs the newer of the two
echo 'x 2020-12-01 - check ELAPSED with a done.txt entry that is newer that the recurrence and won''t be added' > done_verify.txt
echo 'x 2021-02-01 - check ELAPSED with a done.txt entry that is newer that the recurrence and won''t be added' >> done_verify.txt
echo 'x 2020-12-01 - check ELAPSED with a done.txt entry that is older that the recurrence and will be added'   >> done_verify.txt
#
echo
